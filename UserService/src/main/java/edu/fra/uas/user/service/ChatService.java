...
import edu.fra.uas.user.model.ApiError;
import edu.fra.uas.user.model.ChatUser;
...
public class ChatService {
    ...
    String plainCreds;
    // Read the authentication token header name of the external API from properties
    // file.
